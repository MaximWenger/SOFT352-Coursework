...
wsServer.on("request", function(request) {
  ...
  connections[id] = connection; // Add the new connection to the array of connections.
...
function startTicker(){//Used to call main() once a second 
	console.log("Ticker ON");
	timerMain = setInterval(main, 1000); //Calls the main function once a second.
}

function stopTicker(){//Used to stop the timer
